...
export interface ApiTimelineEntryTimelineEntry extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    Category: Schema.Attribute.Enumeration<['professional', 'academic', 'projects']>;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> & Schema.Attribute.Private;
    ...
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::timeline-entry.timeline-entry'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
